...
public class OkHttpUtil {
    ...
    public static String sendFormStringPost(String traceId, String url, String param, int connectTimeoutMilliSeconds, int readTimeoutMilliSeconds, String reqCharset, String resCharset, boolean isBreak) {
        try {
            if (isBreakRequest() && isBreak) {
                return "";
            } else {
                ...
                urlConnection.setConnectTimeout(connectTimeoutMilliSeconds);
                ...
                outputStream.write(param.getBytes(reqCharset));
                outputStream.flush();
                outputStream.close();
                ...
                while (inputStream.read(data) != -1) {
                    String s = new String(data, Charset.forName(resCharset));
                    sb.append(s);
                }
